'''
    ...
    Represents a population of solutions for a multi-objective DNA assembly problem
...
class Population:
    def __init__(self):
        ...
        self.fronts = [[]]
        # Number of individuals allowed in the list
        self.size = None
                ...
                for front in self.fronts:
                    if len(front) > 2:
                        ...
                        for individual_index in range(1,len(front)-1):
                            try:
                                front[individual_index].crowding_distance+= abs(front[individual_index-1].objectives[obj]
                                                         - front[individual_index+1].objectives[obj])/(abs(min-max))
    ...
    def select_individuals(self):
        self.individuals.sort(key=lambda i: (i.rank, -i.crowding_distance))
